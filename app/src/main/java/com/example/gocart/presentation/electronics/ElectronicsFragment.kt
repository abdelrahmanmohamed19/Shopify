...
import com.example.gocart.databinding.FragmentElectronicsBinding
...
class ElectronicsFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        _binding = FragmentElectronicsBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        categoriesViewModel.getCategoriesProducts(token, 44)
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            categoriesViewModel.state.collect{
                ...
                if (it.data != null) {
                    ...
                    binding.tryAgainButton.setOnClickListener{categoriesViewModel.getCategoriesProducts(token, 44)}
                }
            }
        }
    }
