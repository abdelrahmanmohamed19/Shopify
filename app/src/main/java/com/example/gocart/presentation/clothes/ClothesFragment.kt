package com.example.gocart.presentation.clothes
...
class ClothesFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        _binding = FragmentClothesBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        categoriesViewModel.getCategoriesProducts(token, 46)
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            categoriesViewModel.state.collect{
                ...
                if (it.data != null) {
                    ...
                    binding.tryAgainButton.setOnClickListener{categoriesViewModel.getCategoriesProducts(token, 46)}
                }
            }
        }
    }
