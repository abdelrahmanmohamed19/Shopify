...
import com.example.gocart.model.repositories.ProductesRepository
import kotlinx.coroutines.launch

class ProductesViewModel (application: Application): AndroidViewModel(application) {

    val Repo = ProductesRepository(application)
